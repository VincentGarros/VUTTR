    ...
    <>
      ...
      <Modal isOpen={modalState.isOpen} onRequestClose={handleCloseModal}>
        ...
        <Form schema={schema} onSubmit={handleSubmit}>
          <Styled.Container>
            <Styled.Label>Insert Tool Name</Styled.Label>
            <Styled.Input name="title" placeholder="Title" />

            <Styled.Label>Insert Tool Link</Styled.Label>
            <Styled.Input name="link" placeholder="Tool Link" />

            <Styled.Label>Insert Tool Description</Styled.Label>
            <Styled.Textarea name="description" placeholder="Description" />

            <Styled.Label>Insert Some Tags</Styled.Label>
